...
//+------------------------------------------------------------------+
//| Included Libraries Move to CCorrelationTable                     |
//+------------------------------------------------------------------+
//#include "Controls\Controls.mqh"    // Controls Library
 #include <Vendors\Anhnt\Library\3. MVC Table\8. 20596 Refactor\Controls\TableView.mqh>
 #include <Vendors\Anhnt\Library\3. MVC Table\8. 20596 Refactor\Controls\TableControl.mqh>
 #include <Vendors\Anhnt\Library\3. MVC Table\8. 20596 Refactor\Services\DELib.mqh>
...
//Move to CCorrelationTable class and modify name
   //--- global variables
...
int OnInit()
 {
   //Move to CProgram::OnInitEvent
      //--- indicator buffers mapping
      // --- ID of the chart to open
         ExtSymbolsChart=0;
      // --- Looking for a chart subwindow
         int wnd=ChartWindowFind();
   //Move to CCorrelationTable::Setup(const string symbols, uint bars, ENUM_TIMEFRAMES tf)
   ...
   //Move to CCorrelationTable::CreateCorrelationTable(const long chart_id, const int subwin)   
...
//Move to bool CCorrelationTable::GetAndCalculateData(const uint bars_count)
   //+------------------------------------------------------------------+
...
//| Move to bool CCorrelationTable::SymbolsDataMatrixFill(const ENUM_TIMEFRAMES timeframe, string &array[], matrix &data, const int data_count)
//+------------------------------------------------------------------+
...
//| Move to bool CCorrelationTable::CreateTable(CTableControl *table_ctrl)
//+------------------------------------------------------------------+
...
//| Move to CCorrelationTable::UpdateTableValuesAndColors(CTableView *table_view, matrix &matr)
//+------------------------------------------------------------------+
...
//| Move to bool CCorrelationTable::SymbolsSelect(string &array[])   |
//+------------------------------------------------------------------+
