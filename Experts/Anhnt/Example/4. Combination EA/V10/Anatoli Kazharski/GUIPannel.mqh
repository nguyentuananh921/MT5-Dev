  ...
  class CGUIPannel : public CWndEvents
   {
    private:
     ...
     // For CSignalLogger use in GUIPannel_SoundAndMessageAlerts.mqh
        CSignalLogger                   m_signal_logger;                     // EA owns 
      ...
      // Main Tabs
       ...
       // ==== TAB_TAB_MAIN_MONITOR (GUIPannel_MainWindows_TabMonitor.mqh) ====
        ...
        // per-row dirty-check cache for Trade tab table
         ...
         double                          m_double_table_indicator_SymbolTFMonitor_cache_val[]; // raw v0, previous tick - dir_icon compares against THIS now, not v1 (Anhnt/Claude, 2026-09-08)
     ...
     // Setting Window for: Trading Setting Stop Lost And Trailling
      CWindow                           m_window_setting_trading;      
       ...
       //m_table_indicators_trailingsetting declared above alongside m_table_stoplostsetting
         CTextLabel                     m_label_TrailingSetting_Symbol;    // which Symbol m_table_indicators_trailingsetting is currently scoped to
