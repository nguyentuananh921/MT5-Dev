...
//| Initialize                                                       |
//+------------------------------------------------------------------+
void CSignalBridgeWriter::Initialize(ITemplateBuySellProvider *provider, CTimeSeriesEngine *engine, CIndicatorsCollection *ind, CBarTimeSeriesCollection *bars)
  {
   m_provider = provider;
   m_engine = engine;
   m_indicators = ind;
