...
// --- (1) Sets, returns (2) name, (3) active element flag
...
// --- Event handlers for (1) cursor hover (Focus), (2) mouse button presses (Press), (3) cursor movement (Move),
// --- (4) scrolling the wheel (Wheel), (5) leaving focus (Release), (6) creating a graphic object (Create). Redefined in heirs.
...
// --- (4) floating, (5) main element, (6) in focus, (7) graphic object name (background, text)
...
// --- (1) Returns, (2) sets the width of the border at the top
...
// --- Sets the object's (1) relocation flag, (2) main object flag
...
// --- The object is completely or partially inside the visible area of ​​the container
   else
     {
      ...
      // --- If the element is partially in the visible area of ​​the container
        ...
        {
         // --- If the vertical element is in the visible area of ​​the container
         if(object_bottom<=container_bottom && object_top>=container_top)
           ...
           {
            // --- If the horizontal element is in the visible area of ​​the container
            if(object_right<=container_right && object_left>=container_left)
              {
      ...
      if(sparam=="1")
        {
         ...
         // --- Cursor outside object
           ...
           {
            // --- If this is the active main object, or the mouse button is held down on the chart, enable the chart tools
