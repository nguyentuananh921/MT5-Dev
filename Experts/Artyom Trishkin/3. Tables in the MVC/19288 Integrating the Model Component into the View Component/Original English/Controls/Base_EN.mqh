...
enum ENUM_ELEMENT_TYPE                    // Enumeration of types of graphic elements
  {
   ...
   ELEMENT_TYPE_TABLE_HEADER,             // Table title (View)
   ...
   switch(type)
     {
      ...
      case ELEMENT_TYPE_TABLE_HEADER         :  return "THDR";    // Table title (View)
...
// --- (1) Assigns, (2) returns a pointer to the assigned element
...
// --- trimming along container borders
...
//+------------------------------------------------------------------+
// | CCanvasBase::Sets both the coordinates and dimensions of the element |
//+------------------------------------------------------------------+
