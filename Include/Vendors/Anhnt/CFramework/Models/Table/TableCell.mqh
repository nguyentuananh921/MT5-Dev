...
//--- Variables
   ...
   ENUM_TABLE_OBJECT_TYPE  m_object_type;        // Type of stored object
   int                     m_row;                // Row index
   ...
   void AssignObject(CObject *object)
     {
      ...
      this.m_object_type=(ENUM_TABLE_OBJECT_TYPE)object.Type();
     }
...
//--- Return assigned object and its type
   ...
   ENUM_TABLE_OBJECT_TYPE  AssignedObjType(void) const { return this.m_object_type; }
...
//--- Read and verify object type
   ...
   this.m_object_type=(ENUM_TABLE_OBJECT_TYPE)::FileReadInteger(file_handle,INT_VALUE);
...
//                          TypeDescription((ENUM_TABLE_OBJECT_TYPE)this.Type()),this.Row(),this.Col(),
