...
//|Update https://www.mql5.com/en/articles/3527                      |
//+------------------------------------------------------------------+
//| Class for creating a graph                                       |
//+------------------------------------------------------------------+
#ifndef __GRAPH_MQH__
#define __GRAPH_MQH__
...
#include "..\Element.mqh"
 class CGraph : public CElement
  {
   ...
   // --- Objects for creating an element
    CGraphic m_graph;  //CGraphic is a base class for creating custom charts.
   // ---Full screen mode
 ...
 #ifndef CGRAPH_MQH_IMPLEMENTATION
 #define CGRAPH_MQH_IMPLEMENTATION
  //+------------------------------------------------------------------+
  //| Constructor                                                      |
  //+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
 #endif // CGRAPH_MQH_IMPLEMENTATION
#endif // __GRAPH_MQH__
