...
// --- (1) Adds, (2) deletes (3) moves a column, (4) clears data, sets (5) type, (6) precision of column data
...
// --- Sets (1) the value of the specified header, (2) the data precision of the specified column
   void              ColumnCaptionSetValue(const uint index,const string value);
   void              ColumnSetDigits(const uint index,const int digits);
