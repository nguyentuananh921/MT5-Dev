...
public:
// --- Returns (1) list, (2) number of cells, (3) cell
...
// --- We didn’t find the index in the line - we’re leaving
   if(index_str=="")
      return;
...
// --- Creates a (1) header, (2) table object, (3) updates the modified table from the model
...
// --- Returns (1) title, (2) table area, (3) table area container
...
// --- Returns a visual representation object of the specified (1) row, (2) cell
