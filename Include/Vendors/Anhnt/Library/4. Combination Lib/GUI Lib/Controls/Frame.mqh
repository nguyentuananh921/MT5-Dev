...
//|                                              http://www.mql5.com |
//+------------------------------------------------------------------+
#ifndef __FRAME_MQH__
#define __FRAME_MQH__
#include "..\Element.mqh"
...
class CFrame : public CElement
  {
   private:   
    CTextLabel        m_text_label;// --- Instances to create an element
    //--- 
   ...
   public:
                     CFrame(void);
                    ~CFrame(void);   
    CTextLabel       *GetTextLabelPointer(void) { return(::GetPointer(m_text_label)); } // --- Returns a text label pointer
