...
#define __RECTCANVAS_MQH__
 ...
 #endif // CRECTCANVAS_MQH_DECLARATION
 #ifndef CRECTCANVAS_MQH_IMPLEMENTATION
 #define CRECTCANVAS_MQH_IMPLEMENTATION
  //+------------------------------------------------------------------+
  //| Constructor                                                      |
  //+------------------------------------------------------------------+
 ...
 #endif // CRECTCANVAS_MQH_IMPLEMENTATION
#endif // __RECTCANVAS_MQH__
