...
//+------------------------------------------------------------------+
#ifndef __WNDCREATE_MQH__
#define __WNDCREATE_MQH__
...
class CWndCreate : public CWndEvents 
 ...
 #ifndef CWNDCREATE_MQH_IMPLEMENTATION
 #define CWNDCREATE_MQH_IMPLEMENTATION
   //+------------------------------------------------------------------+
   //| Constructor                                                      |
   //+------------------------------------------------------------------+
   ...
   // --- Save the values ​​of the items in the combo box list
     for(int i = 0; i < total; i++)
   ...
   //+------------------------------------------------------------------+
 #endif // CWNDCREATE_MQH_IMPLEMENTATION
#endif // __WNDCREATE_MQH__
