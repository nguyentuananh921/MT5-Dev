 ...
 class CGCnvPatternBitmap : public CGCnvBitmap 
  {
    private:
        ...
        static int CalcWidth(const int scale, const int bars_formation);
        static int CalcHeight(const int chart_h, const double price_max, const double price_min,
    ...
    public:
        CGCnvPatternBitmap(const long chart_id, const int subwin,
                        ...
                        const int scale, const int chart_h,
...
#define CGCNVPATTERNBITMAP_MQH_IMPLEMENTATION
 ...
 int CGCnvPatternBitmap::CalcWidth(const int scale, const int bars_formation) 
  {
    int slot_w = (int)(1 << scale);
    return (2 * bars_formation - 1) * slot_w + 1;
  }

 int CGCnvPatternBitmap::CalcHeight(const int chart_h, const double price_max, const double price_min,
                                   const double price_high, const double price_low)
  {
 ...
 CGCnvPatternBitmap::CGCnvPatternBitmap(const long chart_id, const int subwin,
                                       ...
                                       const int bars_formation,
                                       const int scale, const int chart_h,
                                       const double price_max, const double price_min) : CGCnvBitmap(GRAPH_ELEMENT_TYPE_BITMAP, NULL, NULL,
                                                                               obj_id, 0, chart_id, subwin,
                                                                               name, anchor_time, (price_high + price_low) / 2.0,
                                                                               CalcWidth(scale, bars_formation),
                                                                               CalcHeight(chart_h, price_max, price_min, price_high, price_low),
                                                                               clrNONE, 200) 
  {
    m_dir = dir;
