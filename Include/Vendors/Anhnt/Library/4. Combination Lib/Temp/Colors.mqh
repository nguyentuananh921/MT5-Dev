//Using Colors in Service Instead
   ...
   // //+------------------------------------------------------------------+
   // #ifndef __COLORS_MQH__
   // #define __COLORS_MQH__
   // class CColors
   //   {
   // private:
   ...
   //                      CColors();
   //                     ~CColors();
   //    // --- List of functions from the site > http:www.easyrgb.com/index.php?X=MATH
   //    //    start of list <
   ...
   //   };
   //  #ifndef CCOLORS_MQH_IMPLEMENTATION
   //  #define CCOLORS_MQH_IMPLEMENTATION
   //    //+------------------------------------------------------------------+
   //    //| Constructor                                                      |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Getting the value of the R component |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Getting the value of the G component |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Getting the value of component B |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Getting the value of component A |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Getting an intermediate color value between two colors |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Mixing two colors, taking into account the transparency of the top |
   //    //+------------------------------------------------------------------+
   ...
   //       if(alpha<1.0)
   //         {
   //          // --- Mixing components taking into account the alpha channel
   //          r3=(r1*(1-alpha))+(r2*alpha);
   //          g3=(g1*(1-alpha))+(g2*alpha);
   //          b3=(b1*(1-alpha))+(b2*alpha);    
   //          // --- Correction of obtained values
   //          r3=(r3>255)? 255 : r3;
   //          g3=(g3>255)? 255 : g3;
   //          b3=(b3>255)? 255 : b3;
   //         }
   ...
   //          b3=b2;
   //         }
   //    // --- Combine the resulting components and return the color
   //       return(RGBToColor(r3,g3,b3));
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Getting an array of a given size with a color gradient |
   //    //+------------------------------------------------------------------+
   //    void CColors::Gradient(color &aColors[],   // List of colors
   //                           color &aOut[],      // Return array
   //                           int   aOutCount,    // Setting the size of the returned array
   //                           bool  aCycle=false) // Closed loop. The returned array ends with the same color it starts with
   //      {
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //    // | Another option for converting RGB to XYZ and |
   //    // | its corresponding XYZ to RGB conversion |
   //    //+------------------------------------------------------------------+
   ...
   //    // | in a set of standard terminal colors |
   //    //+------------------------------------------------------------------+
   ...
   //      }
   //    //+------------------------------------------------------------------+
   //  #endif // CCOLORS_MQH_IMPLEMENTATION
   // #endif // __COLORS_MQH__
