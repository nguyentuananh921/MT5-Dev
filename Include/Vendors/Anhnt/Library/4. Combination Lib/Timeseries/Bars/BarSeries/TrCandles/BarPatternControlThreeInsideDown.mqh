...
#define __BARPATTERNCONTROLTHREEINSIDEDOWN_MQH__
 ...
 #include "..\..\BarSeriesPatterns\TrCandlesPatterns\PatternThreeInsideDown.mqh"
 ...
 #define CBarPatternControlThreeInsideDown_MQH_IMPLEMENTATION
   ...
   //+------------------------------------------------------------------+
   //| Search for Three Inside Down ending at series_bar_time           |
   //+------------------------------------------------------------------+
   ENUM_PATTERN_DIRECTION CBarPatternControlThreeInsideDown::FindPattern(const datetime series_bar_time,
