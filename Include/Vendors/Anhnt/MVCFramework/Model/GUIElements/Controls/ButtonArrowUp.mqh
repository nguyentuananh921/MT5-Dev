...
//+------------------------------------------------------------------+
//| CButtonArrowUp::Parameterized constructor                        |
//| Builds a button in the specified window of the specified chart  |
//| with the specified text, coordinates and size                   |
//+------------------------------------------------------------------+
...
//--- Initialize properties of the auto-repeat event control object
...
//+------------------------------------------------------------------+
//| CButtonArrowUp::Compare two objects                              |
//+------------------------------------------------------------------+
int CButtonArrowUp::Compare(const CObject *node,const int mode) const
  {
   return CButton::Compare(node,mode);
  }

//+------------------------------------------------------------------+
//| CButtonArrowUp::Draw appearance                                  |
//+------------------------------------------------------------------+
...
//--- Set arrow color for normal and disabled button states and draw the up arrow
