...
input int      InpIrChannelWidth   = 2;
#property indicator_applied_price PRICE_CLOSE
//--- input params
input int InChPeriod = 14; //Channel Period
...
void OnInit()
  ...
  PlotIndexSetInteger(0,  PLOT_LINE_WIDTH, InpIrChannelWidth);
  PlotIndexSetInteger(1,  PLOT_LINE_WIDTH, InpIrChannelWidth);
  PlotIndexSetInteger(2,  PLOT_LINE_WIDTH, InpIrChannelWidth);
  PlotIndexSetInteger(3,  PLOT_LINE_WIDTH, InpIrChannelWidth);
  PlotIndexSetInteger(4,  PLOT_LINE_WIDTH, InpIrChannelWidth);
